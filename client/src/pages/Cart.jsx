...
import { CartLoadingState } from '../components/StoreLoadingStates'
import Footer from '../components/Footer'
import { handleImageError } from '../lib/catalog'
import { formatItemCount, formatPrice } from '../lib/format'

function Cart() {
  const { cartItems, cartHydrated, updateQty, removeItem, cartTotal } = useOutletContext()
    ...
    <div className="page">
      <section className="page-hero">
        ...
        <div className="hero-cta">
          <span>{formatItemCount(cartItems.length, 'item')}</span>
          <button className="btn primary" type="button" onClick={() => navigate('/checkout')}>
            Checkout
          </button>
        </div>
      </section>
